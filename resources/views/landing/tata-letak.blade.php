...
<div class="lp-navbar-wrap">
    <nav class="lp-navbar {{ request()->routeIs('landing.home') ? '' : 'is-page' }}" id="lpNavbar">
        ...
        <a href="{{ route('landing.ppdb') }}" class="lp-cta d-none d-lg-inline-flex">Daftar PPDB</a>
    </nav>
</div>
        ...
        <div class="row g-4 align-items-start">
            ...
            <div class="col-lg-3 col-md-4">
                ...
                <ul class="list-unstyled m-0">
                    ...
                    <li class="mb-2"><a href="{{ route('landing.pengumuman') }}">Pengumuman</a></li>
                    <li class="mb-2"><a href="{{ route('landing.galeri') }}">Galeri</a></li>
                    <li class="mb-2"><a href="{{ route('landing.ppdb') }}">PPDB</a></li>
                    <li class="mb-2"><a href="{{ route('landing.kontak') }}">Kontak</a></li>
                </ul>
            </div>
            ...
            <div class="col-lg-4 col-md-8">
                ...
                <a href="{{ route('landing.kontak') }}" class="lp-link-soft" style="color:#fff;">

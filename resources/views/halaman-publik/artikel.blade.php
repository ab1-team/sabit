...
<style>
    ...
    @media (max-width: 767.98px) {
        .lp-article { padding: 1.25rem; border-radius: var(--lp-radius-lg); }
        .lp-article h1 { font-size: 1.45rem; }
        .lp-content { font-size: 0.95rem; }
    }
    @media (max-width: 575.98px) {
        .lp-article { padding: 1rem; }
    }
</style>
@endsection
        ...
        <div class="row justify-content-center">
            <div class="col-lg-9">
                <article class="lp-article lp-reveal" data-from="zoom">
                    ...
                    <a href="{{ route('halaman-publik.daftar-artikel') }}" class="lp-link-soft mt-4 d-inline-flex">

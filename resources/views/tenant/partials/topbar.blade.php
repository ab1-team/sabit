@php
    $navItems = [
        ['route' => 'tenant.dashboard', 'match' => 'tenant.dashboard*', 'label' => 'Dashboard', 'icon' => 'home'],
        ...
        ['route' => 'tenant.invoice.index', 'match' => 'tenant.invoice.*', 'label' => 'Invoices', 'icon' => 'doc'],
    ];
    ...
    <div class="mx-auto max-w-7xl px-3 sm:px-6 lg:px-8">
        <div class="flex min-h-16 items-center justify-between gap-2 sm:gap-3">
            <div class="flex min-w-0 flex-shrink-0 items-center gap-3">
                <a href="{{ route('tenant.dashboard') }}" aria-label="Tenant dashboard" class="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-indigo-500 to-purple-600 shadow-md shadow-indigo-500/20">
...
<script>
    ...
    function confirmLogout(e) {
        e.preventDefault();
        Swal.fire({
            title: 'Sign out of Tenant Console?',

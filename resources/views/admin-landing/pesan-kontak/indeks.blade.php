...
<div class="px-2 py-2">
    ...
    <form method="GET" action="{{ route('app.admin-landing.contact-messages') }}" class="card mb-3">
        <div class="card-body p-3">
            <div class="row g-2 align-items-end">
                ...
                <div class="col-md-3 d-flex gap-2">
                    ...
                    <a href="{{ route('app.admin-landing.contact-messages') }}" class="btn btn-sm btn-light">Reset</a>
                </div>
            </div>
        </div>
    </form>

...
<div class="px-2 py-2">
    ...
    @php
        $addBtn = '<a href="'.e(route('app.admin-landing.fasilitas.create')).'" class="btn btn-sm btn-primary">'
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-1">
                                            <a href="{{ route('app.admin-landing.fasilitas.edit', $row->id) }}"
                                               class="btn btn-sm btn-outline-primary">
                                                <span class="material-symbols-rounded" style="font-size:16px;">edit</span>
                                            </a>
                                            @include('admin-landing._komponen.formulir-hapus', [
                                                'action' => route('app.admin-landing.fasilitas.destroy', $row->id),

...
<div class="px-2 py-2">
    ...
    <div id="lpNewSchedule" class="collapse mb-3">
        @include('landing-admin._components._inline-form', [
            'action' => route('app.landing.ppdb.schedules.store'),
            'method' => 'POST',
            'fields' => [
                    ...
                    <div class="accordion-item mb-2 border rounded">
                        ...
                        <div id="sched-{{ $row->id }}" class="accordion-collapse collapse" data-bs-parent="#lpSchedulesAccordion">
                            <div class="accordion-body">
                                @include('landing-admin._components._inline-form', [
                                    'action' => route('app.landing.ppdb.schedules.update', $row->id),
                                    'method' => 'PUT',
                                    'fields' => [
                                        'gelombang' => ['label' => 'Gelombang', 'required' => true, 'col' => 12],
                                        'start_date' => ['label' => 'Tanggal Mulai', 'type' => 'date', 'required' => true, 'col' => 4],
                                ...
                                <div class="d-flex justify-content-end">
                                    @include('landing-admin._components.delete-form', [
                                        'action' => route('app.landing.ppdb.schedules.destroy', $row->id),

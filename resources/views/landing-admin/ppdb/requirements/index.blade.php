...
<div class="px-2 py-2">
    ...
    <div id="lpNewRequirement" class="collapse mb-3">
        @include('landing-admin._components._inline-form', [
            'action' => route('app.landing.ppdb.requirements.store'),
            'method' => 'POST',
            'fields' => [
                    ...
                    <div class="accordion-item mb-2 border rounded">
                        ...
                        <div id="req-{{ $row->id }}" class="accordion-collapse collapse" data-bs-parent="#lpRequirementsAccordion">
                            <div class="accordion-body">
                                ...
                                @endif
                                @include('landing-admin._components._inline-form', [
                                    'action' => route('app.landing.ppdb.requirements.update', $row->id),
                                    'method' => 'PUT',
                                    'fields' => [
                                ...
                                <div class="d-flex justify-content-end">
                                    @include('landing-admin._components.delete-form', [
                                        'action' => route('app.landing.ppdb.requirements.destroy', $row->id),

...
<div class="px-2 py-2">
    ...
    @php
        $addBtn = '<a href="'.e(route('app.landing.struktur.create')).'" class="btn btn-sm btn-primary">'
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-1">
                                            <a href="{{ route('app.landing.struktur.edit', $row->id) }}"
                                               class="btn btn-sm btn-outline-primary">
                                                <span class="material-symbols-rounded" style="font-size:16px;">edit</span>
                                            </a>
                                            @include('landing-admin._components.delete-form', [
                                                'action' => route('app.landing.struktur.destroy', $row->id),
